...
public class StarEnd extends PApplet {
    ...
    public void setup()
    {
        ...
        endLogo = loadImage("endLogo.png");
        endLogo.resize(width/2,width/8);
    ...
    public void draw()
    {
        ...
        image(endLogo,width/2,height/4);
        woman.display(width/2-100,height-height/8);
        man_first.display(width/2+100,height-height/8+20);
        man_second.display(width/2,height-height/8+20);
